...
//	GPIO_InitStructure.GPIO_Mode=GPIO_Mode_Out_PP;
	...
	pidInit(&cont_m0,10,1,2,MOTOR_MAXIMO,MOTOR_MAXIMO);
	pidInit(&cont_m1,10,1,2,MOTOR_MAXIMO,MOTOR_MAXIMO);
	pidInit(&cont_m2,10,1,2,MOTOR_MAXIMO,MOTOR_MAXIMO);
	pidInit(&cont_m3,10,1,2,MOTOR_MAXIMO,MOTOR_MAXIMO);
