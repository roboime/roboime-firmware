...
GPIO_TypeDef* MAH_Port[] = {GPIOC, GPIOA, GPIOC, GPIOE};
...
uint32_t MAH_Pin[] = {GPIO_Pin_9, GPIO_Pin_8, GPIO_Pin_6, GPIO_Pin_14};
uint32_t MAL_Pin[] = {GPIO_Pin_5, GPIO_Pin_6, GPIO_Pin_2, GPIO_Pin_12};
uint32_t MBH_Pin[] = {GPIO_Pin_7, GPIO_Pin_8, GPIO_Pin_11, GPIO_Pin_13};
uint32_t MBL_Pin[] = {GPIO_Pin_13, GPIO_Pin_4, GPIO_Pin_1, GPIO_Pin_11};
...
GPIO_TypeDef* M_EncA_Port[] = {GPIOB, GPIOA, GPIOA, GPIOB};
GPIO_TypeDef* M_EncB_Port[] = {GPIOB, GPIOB, GPIOA, GPIOB};

uint32_t M_EncA_Pin[] = {GPIO_Pin_4, GPIO_Pin_15, GPIO_Pin_0, GPIO_Pin_6};
uint32_t M_EncB_Pin[] = {GPIO_Pin_5, GPIO_Pin_3, GPIO_Pin_1, GPIO_Pin_7};
