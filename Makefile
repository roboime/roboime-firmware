...
#TOOLCHAIN_PATH_TEMP:=`which $TOOLCHAIN_PREFIX`
#TOOLCHAIN_PATH:=${TOOLCHAIN_PATH_TEMP%/*}
TOOLCHAIN_PATH:=/opt/local/bin
...
DISCOVERY:=./utils/STM32F4-Discovery
...
LINKER_SCRIPT:=$(CURDIR)/vendor/stm32_flash.ld
